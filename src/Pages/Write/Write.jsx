    ...
    if(file)
    {
      ...
      try{
       formdata.forEach(val => console.log(val));
        const result = await axios.post(`https://blog-node-backend-shg7.onrender.com/upload`,formdata)
        ...
        const res= await axios.post(`https://blog-node-backend-shg7.onrender.com/api/posts/`,obj);
